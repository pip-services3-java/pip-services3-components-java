...
public class DefaultLoggerFactory extends Factory {
	...
	public final static Descriptor ConsoleLoggerDescriptor = new Descriptor("pip-services", "logger", "console", "*", "1.0");
	public final static Descriptor CompositeLoggerDescriptor = new Descriptor("pip-services", "logger", "composite", "*", "1.0");
	public final static Descriptor NullLoggerDescriptor = new Descriptor("pip-services", "logger", "null", "*", "1.0");
		
	public final static Descriptor DiagnosticsLoggerDescriptor  = new Descriptor("pip-services", "logger", "diagnostics", "*", "1.0");
